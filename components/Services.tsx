const services = [
  ...
  },
  {
    ...
    title: "Clawdbot Secure Installation",
    description:
      "Get Clawdbot installed securely on your machine. We handle the setup, configuration, and hardening so you can start using it with confidence and peace of mind.",
  },
];
